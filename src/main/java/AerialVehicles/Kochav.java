...
public class Kochav extends AerialVehicle implements  AerialVehicleService,AerialAttackVehicle,AerialIntelligenceVehicle, HermesVehicle, AerialBdaVehicle{
    ...
    public Kochav(Integer numberOfMissiles, String typeOfMissiles,String cameraType, String sensorType, String pilotName, AttackMission mission, Integer flightHours, boolean isReadyToFly) {
        super();
