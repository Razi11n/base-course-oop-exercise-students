...
public class Zik extends AerialVehicle implements  AerialVehicleService,AerialIntelligenceVehicle, HermesVehicle, AerialBdaVehicle{


    public String mSensorType = "";
    public String mCameraType ="";
    public Zik(String cameraType, String sensorType, String pilotName, BdaMission mission, Integer flightHours, boolean isReadyToFly) {
        super();
