...
public class Eitan extends AerialVehicle implements  AerialVehicleService,AerialAttackVehicle,AerialIntelligenceVehicle, HaronVehicle{

    public Integer mNumberOfMissiles = 0;
    public String mMissileType = "";
    public String mSensorType = "";
    public Eitan(Integer numberOfMissiles, String typeOfMissiles, String sensorType, String pilotName, AttackMission mission, Integer flightHours, boolean isReadyToFly) {
        super();
